...
fn main() {
    ...
    let iters = [1, 2];
    benchmark(benchmark_sha2_chain, &iters, "../../benchmark_outputs/sha2_chain_stone.csv", "iters");
...
fn benchmark_sha2_chain(iters: u32) -> (Duration, usize) {
    ...
    let output_path = "programs/sha256_chain_compiled.json".to_string();
