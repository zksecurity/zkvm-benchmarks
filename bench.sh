...
if [ "$MODE" = "local" ]; then
    ...
    FIB_ARG="4096 8192 16384 32768 65536 131072 262144 524288 1048576 2097152"
    SHA_ARG="256 512 1024 2048 4096 8192 16384 32768 65536 131072"
    SHA_CHAIN_ARG="8 16 32 64 128 256 512 1024 2048 4096 8192 16384 32768"
    MATMUL_ARG="4 8 16 32 64 128 256"
    EC_ARG="16 32 64 128 256 512 1024 2048 4096 8192"
    just bench-all "$FIB_ARG" "$SHA_ARG" "$SHA_CHAIN_ARG" "$MATMUL_ARG" "$EC_ARG"
else
