...
fn run(n: u32, bench_mem: bool) {
    ...
    let parameter_file = match n {
        100 | 500 | 1000 => "../configs/parameter_65536_32.json".to_string(),
        5000 | 10000 => "../configs/parameter_65536_64.json".to_string(),
        50000 | 100000 => "../configs/parameter_524288.json".to_string(),
