...
fn run(n: u32, bench_mem: bool) {
    ...
    // Get PIE Output
    let steps_command = "cairo-run --program=programs/sha256_chain.json --cairo_pie_output=get_steps.zip --layout=starknet_with_keccak --program_input=programs/input.json";
